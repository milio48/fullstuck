...
- [x] **Basic Query Builder**:
  Selesai! Fungsi helper seperti `fst_db_insert('users', ['name'=>'Budi'])` dan `fst_db_select('users', ['id' => 1])` kini tersedia.
...
---
## Prioritas Eksekusi
- (Semua task arsitektural selesai, siap untuk digunakan!)
